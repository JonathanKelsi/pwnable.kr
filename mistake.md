...
Taking a closer look at the opening of the password file, we see that `fd` is assigned the result of `open("/home/mistake/password",O_RDONLY,0400) < 0`, because of operator priority. 
